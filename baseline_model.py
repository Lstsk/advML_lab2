...
class UNetDoubleConv(nn.Module):
    """Original-style repeated conv block used throughout U-Net."""
...
class UNetUpBlock(nn.Module):
    """Expansive path block with skip concatenation."""
...
class UNet(nn.Module):
    """Plain U-Net baseline for segmentation."""
    ...
    def __init__(self, in_channels: int = 3, num_classes: int = 19, base_ch: int = 64) -> None:
        ...
        self.dec1 = UNetUpBlock(base_ch * 8, base_ch * 4, base_ch * 4)
        self.dec2 = UNetUpBlock(base_ch * 4, base_ch * 2, base_ch * 2)
        self.dec3 = UNetUpBlock(base_ch * 2, base_ch, base_ch)
